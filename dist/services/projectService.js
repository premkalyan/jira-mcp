...
export class ProjectService {
    ...
    async getProjects() {
        try {
            ...
            const markdownTable = formatMarkdownTable(['Key', 'Name', 'Type', 'Lead', 'Issue Types', 'Components', 'Versions'], tableData);
...
- Create new issue: Use \`create_issue\` with any project key`,
    ...
    async getProjectDetails(projectKey) {
        try {
            ...
            const project = await this.apiClient.getProject(projectKey);
