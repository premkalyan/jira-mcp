...
const TOOLS = [
  ...
  { name: 'update_worklog', description: 'Update an existing work log entry', inputSchema: { type: 'object', properties: { issueKey: { type: 'string' }, worklogId: { type: 'string' }, timeSpent: { type: 'string' }, comment: { type: 'string' } }, required: ['issueKey', 'worklogId'] } },
  { name: 'delete_worklog', description: 'Delete a work log entry', inputSchema: { type: 'object', properties: { issueKey: { type: 'string' }, worklogId: { type: 'string' } }, required: ['issueKey', 'worklogId'] } },
  { name: 'get_my_worklogs', description: 'Get work logs by current user for a date range (timesheet)', inputSchema: { type: 'object', properties: { startDate: { type: 'string' }, endDate: { type: 'string' }, projectKey: { type: 'string' } }, required: ['startDate', 'endDate'] } },
  { name: 'get_sprint_worklogs', description: 'Get aggregate work logs for all issues in a sprint', inputSchema: { type: 'object', properties: { sprintId: { type: 'string' }, boardId: { type: 'string' }, groupBy: { type: 'string' } } } },
